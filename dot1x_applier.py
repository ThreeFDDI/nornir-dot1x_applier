...
IBNS version 1 or 2 templates will be applied based on switch model. Catalyst
3750 series switches will recieve IBNS version 1 and all other switch models
will receive IBNS version 2. 

Additional variables required from SimepleInventory:
